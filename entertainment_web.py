...
"""import script that creates html page of the movie list
stored in this file"""

import media
"""import movie class constuctor"""
...
bountyHunter = media.Movie("The Bounty Hunter",
                           "2010",
                           "action",
                           "A bounty hunter learns that his next target is " +
...
theBigYear = media.Movie("The Big Year",
                         "2011",
                         "comedy",
                         "A big year is an informal competition among birde" +
...
pacificRim = media.Movie("Pacific Rim",
                         "2013",
                         "action",
                         "As a war between humankind and monstrous sea" +
...
greatGatsby = media.Movie("The Great Gatsby",
                          "2013",
                          "drama",
                          "A writer and wall street trader, Nick, finds " +
                          "himself drawn to the past. While the movie has" +
...
internship = media.Movie("The Internship",
                         "2013",
                         "comedy",
                         "Two salesmen whose careers have been torpedoed by " +
...
focus = media.Movie("Focus",
                    ...
                    "a woman from his past - now an ..... Overall, Focus is" +
...
beautyAndTheBeast = media.Movie("Beauty And The Beast",
                                "2014",
                                "fantasy",
                                "An unexpected romance blooms after the the" +
                                "youngest daughter of a merchant who has " +
...
draft = media.Movie("Draft Day",
                    ...
                    "the opportunity to rebuild his .... The actual 2014 " +
...
threeDaysToKill = media.Movie("3 Days To Kill",
                              "2014",
                              "action",
                              "A dying CIA agent trying to reconnect with " +
...
hotelTransylvania = media.Movie("Hotel Transylvania 2",
                                ...
                                "the monster in his half human, half vampire" +
                                "grandson in order to keep Mavis from " +
                                "leaving the hotel. ",
                                "http://www.impawards.com/2015/posters/hotel" +
                                "_transylvania_two_ver5.jpg",
